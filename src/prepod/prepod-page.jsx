...
function PrepodPage(props) {
    ...
    return (
        ...
        <Paper>
            <a href="http://45.141.79.25:4000/api/logOut"><Button color="primary" variant="outlined" sizes="small" className={classes.btn}><img className={classes.image} src={logOut} alt="logOut"/></Button></a>
